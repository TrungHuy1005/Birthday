...
$(window).on('load', function (event) {
    ...
    const textToType = myLover.Name + " - " + myLover.Age;
...
const textLetterP = contentPoster.textContent;
...
document.querySelector(".buttonLove").addEventListener("click", function () {
    ...
    let timeout = setInterval(() => {
        ...
        letters.innerHTML = '<img src="./images/letters.png" alt="">';
